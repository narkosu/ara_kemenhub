    ...
    <div class="speedbar-content">
		...
		<Div style="float:left;">
			...
			<span class="button-group">
				<a href="<?php echo Yii::app()->createUrl('masters/peserta/rekapitulasi')?>" class="button icon home">
				Laporan Peserta</a>
        			<a href="<?php echo Yii::app()->createUrl('masters/laporan/rekapitulasi')?>" class="button icon home">
        			Summary Peserta Data</a>
<a href="<?php echo Yii::app()->createUrl('penilaian/laporan/rekapitulasi')?>" class="button icon home">
        			Rekap Kompetensi Data</a>
